...
Pygo crashed! This is always indicative of a bug within pygo.
Please report the crash with Pygo[1] so that we can fix this.

When reporting bugs, please include your pygo version, the stack trace
shown below, and any additional information which may help replicate the issue.

[1]: https://github.com/yanndegat/pygo/issues

!!!!!!!!!!!!!!!!!!!!!!!!!!! PYGO CRASH !!!!!!!!!!!!!!!!!!!!!!!!!!!!

`

// PanicHandler is called to recover from an internal panic in pygo, and
